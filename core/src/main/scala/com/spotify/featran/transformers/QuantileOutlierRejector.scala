...
import com.twitter.algebird._
 ...
 /**
  * Rejects features if they are contained in the last quantile defined by
  * the number of buckets in the `numBuckets` parameter.
  *
...
object QuantileOutlierRejector {
    ...
    *
    * @param rejectLower whether to reject outlier based on the first quantile.
    * @param rejectUpper whether to reject outlier based on the last quantile.
